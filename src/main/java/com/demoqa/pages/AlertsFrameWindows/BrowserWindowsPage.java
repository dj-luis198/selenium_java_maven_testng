...
public class BrowserWindowsPage extends BaseClass {
    ...
    public void openAndGoWindowMessage() {
        BaseClass.openNewTabAndSwitch(messageWindowButton);
    }

    public String openAndGoWindow() {
        String url= BaseClass.openNewTabAndSwitch(windowButton);
        return url;
    }

    public String openAndGoTab() {
        String url= BaseClass.openNewTabAndSwitch(tabButton);
        return url;
    }
