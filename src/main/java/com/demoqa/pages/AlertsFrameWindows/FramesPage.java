...
public class FramesPage extends BaseClass {
    ...
    public void goToFrame1() {
        BaseClass.switchToTheFrame(frame1);
    }

    public void goToFrame2() {
        BaseClass.switchToTheFrame(frame2);
    }

    public Boolean verifiTextFrame() {
        if (BaseClass.getTextContent(textFrame).equals("This is a sample page")) {
            return true;
        }
        return false;
    }
    ...
    public Boolean verifiTextDefaultContent() {
        if (BaseClass.getTextContent(textDefaultContent).equals(
