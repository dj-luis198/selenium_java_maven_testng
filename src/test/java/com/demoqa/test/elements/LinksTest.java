...
public class LinksTest extends BaseTest{
    ...
    public void FollowingLinksWillSendAnApiCallCreate (){
       ...
       .then()
            .log().all()
            .statusCode(201);
        Assert.assertEquals(linksPage.returnLinkResponseMsg(),"Link has responded with staus 201 and status text Created");
    }
    ...
    public void FollowingLinksWillSendAnApiCallNoContent (){
       ...
       .then()
            .log().all()
            .statusCode(204);
        Assert.assertEquals(linksPage.returnLinkResponseMsg(),"Link has responded with staus 204 and status text No Content");
    }
    ...
    public void FollowingLinksWillSendAnApiCallMoved (){
       ...
       .then()
            .log().all()
            .statusCode(301);
        Assert.assertEquals(linksPage.returnLinkResponseMsg(),"Link has responded with staus 301 and status text Moved Permanently");
    }
    ...
    public void FollowingLinksWillSendAnApiCallBadRequest (){
       ...
       .then()
            .log().all()
            .statusCode(400);
        Assert.assertEquals(linksPage.returnLinkResponseMsg(),"Link has responded with staus 400 and status text Bad Request");
    }
    ...
    public void FollowingLinksWillSendAnApiCallUnauthorized (){
       ...
       .then()
            .log().all()
            .statusCode(401);
        Assert.assertEquals(linksPage.returnLinkResponseMsg(),"Link has responded with staus 401 and status text Unauthorized");
    }
    ...
    public void FollowingLinksWillSendAnApiCallForbidden (){
       ...
       .then()
            .log().all()
            .statusCode(403);
        Assert.assertEquals(linksPage.returnLinkResponseMsg(),"Link has responded with staus 403 and status text Forbidden");
    }
    ...
    public void FollowingLinksWillSendAnApiCallNotFound (){
       ...
       .then()
            .log().all()
            .statusCode(404);
        Assert.assertEquals(linksPage.returnLinkResponseMsg(),"Link has responded with staus 404 and status text Not Found");
    }
}
